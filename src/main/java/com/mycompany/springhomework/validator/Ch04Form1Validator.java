...
public class Ch04Form1Validator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		if(param1 == null || param1.equals("")) {
			...
			errors.rejectValue("param1", "errors.form.maxlength", new Object[] {15}, "최소 15자 입력(D)");
		}
		...
		if(param3 == null || param3.equals("")) {
			errors.rejectValue("param3", "errors.form.required", "필수입력(D)");
		} else {
